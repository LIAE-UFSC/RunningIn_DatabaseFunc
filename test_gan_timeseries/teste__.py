...
# Caso queira fazer uma avaliação após o treinamento
# Aqui vamos avaliar com o dataset de teste
x_test = dataset["x_val"]  # Usando os dados de validação para teste (como exemplo)
model.evaluate(x_test, x_test, model.loss_function)
